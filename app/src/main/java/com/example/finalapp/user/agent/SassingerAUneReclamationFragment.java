...
public class SassingerAUneReclamationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_sassinger_aune_reclamation, container, false);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myRef.child("claim").child(recId).child("etat").setValue("En cours");
                myRef.child("claim").child(recId).child("agentId").setValue(uid);
            }
        });
    ...
    public void onStart() {
        ...
        myRef.child("claim").child(recId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(textView4.getText().toString().startsWith("E")) button.setVisibility(View.INVISIBLE);
            }
